...
<body>
    ...
    <nav class="navbar">
        ...
        <ul class="nav-links">
            <li class="nav-items"><a href="#">ODIYAMMMA BUNTY - MITSSSS_ CSEE _DEVOPS </a></li>
        ...
        <div class="carousel">
            <!-- <div class="slider">
                <div class="slide-content">
                    ...
                    <p class="movie-des">Lorem  title, sit amet consectetur adipisicing elit. Quam distinctio molestiae quis praesentium cum obcaecati eveniet voluptates exercitationem eum accusantium.</p>
                </div>
    ...
    <div class="movies-list">
        ...
        <div class="card-container">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <h2 class="name">Loki Season 2</h2>
